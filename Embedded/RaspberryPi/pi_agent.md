...
| 4 | **Nomenclature:** Load 3 → **Static Zone 1**, Load 4 → **Static Zone 2**. | ✅ **Resolved 2026-08-07** in `../../PCB/PCB_V3/Connections.md` §4, including the buck rails which read "Zone A"/"Zone B" (was cited as `pin-map.md`, which does not exist). |
